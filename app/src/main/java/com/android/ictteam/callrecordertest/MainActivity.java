...
public class MainActivity extends AppCompatActivity {
    ...
    private int REQUEST_READWRITE_STORAGE = 1;
    ...
    protected void onResume() {
        ...
        int permissionCheck4 = ContextCompat.checkSelfPermission(this, Manifest.permission.RECORD_AUDIO);
        if (permissionCheck4 != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(this,
                    new String[]{Manifest.permission.RECORD_AUDIO}, 1);
        }
        int permissionCheck5 = ContextCompat.checkSelfPermission(this, Manifest.permission.READ_CONTACTS);
        int permissionCheck6 = ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_CONTACTS);
        if (permissionCheck5 != PackageManager.PERMISSION_GRANTED || permissionCheck6 != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(this,
                    new String[]{Manifest.permission.READ_CONTACTS,
                            Manifest.permission.WRITE_CONTACTS}, 1);
        }
        int permissionCheck7 = ContextCompat.checkSelfPermission(this, Manifest.permission.BIND_INCALL_SERVICE);
        if (permissionCheck7 != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(this,
                    new String[]{Manifest.permission.BIND_INCALL_SERVICE}, 1);
        }
        int permissionCheck8 = ContextCompat.checkSelfPermission(this, Manifest.permission.BIND_VOICE_INTERACTION);
        if (permissionCheck8 != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(this,
                    new String[]{Manifest.permission.BIND_VOICE_INTERACTION}, 1);
        }
        int permissionCheck9 = ContextCompat.checkSelfPermission(this, Manifest.permission.CAPTURE_AUDIO_OUTPUT);
        if (permissionCheck9 != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(this,
                    new String[]{Manifest.permission.CAPTURE_AUDIO_OUTPUT}, REQUEST_READWRITE_STORAGE);
        }
        super.onResume();
    }
