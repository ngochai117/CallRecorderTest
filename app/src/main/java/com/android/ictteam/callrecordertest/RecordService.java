...
public class RecordService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null) {
            ...
            Log.d(Constants.TAG, "RecordService commandType:" + String.valueOf(commandType));
            if (commandType != 0) {
    ...
    private void startRecording(Intent intent) {
        ...
        try {
            ...
            {
                Log.d(Constants.TAG, "RecordService VOICE_COMMUNICATION");
                recorder.setAudioSource(MediaRecorder.AudioSource.VOICE_CALL);
            }
            else
            {
                Log.d(Constants.TAG, "RecordService VOICE_CALL");
                recorder.setAudioSource(MediaRecorder.AudioSource.VOICE_CALL);
            }
